        ...
        try {
            ...
            if (isReceptionistOrAdmin && data.customerName && data.customerPhone) {
                bookingData.customerDetails = {
                    ...
                    ...(data.customerEmail && { email: data.customerEmail }), // Email is optional
                };
            }
            // For guest users, no customerDetails needed (backend uses currentUser.id)

            const response = await createBooking(bookingData);

            if (response.success) {
                const successMessage = isReceptionistOrAdmin && data.customerName
                    ? `Booking created successfully for ${data.customerName}!`
